...
console.log(texto2.match(/(?:lenta)(mente).*\1/gi)); // ?: Não armaneza o "lenta" no retrovisor

console.log(texto2.match(/lenta(mente)/gi));
console.log(texto2.match(/lenta(mente)?/gi));
console.log(texto2.replace(/(lenta)(mente)/gi, '$2')); // $2 pega o segundo retrovisor para passar na substituição
